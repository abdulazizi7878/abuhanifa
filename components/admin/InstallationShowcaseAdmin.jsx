...
export default function InstallationShowcaseAdmin() {
    ...
    // Load existing showcase photos via admin endpoint
    ...
    // Upload Photo via POST /api/installation-showcase
    const handleUpload = async (e) => {
        ...
        try {
            // Content-Type header is intentionally omitted for FormData
            const res = await fetch("/api/installation-showcase", {
                method: "POST",
                body: formData,
            });
    ...
    // Delete Photo via DELETE /api/installation-showcase
