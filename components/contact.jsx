                ...
                <div className="w-full flex flex-col gap-10">
                    ...
                    <div className="border border-(--border) flex flex-col justify-center items-center gap-10 h-60 rounded-4xl">
                        ...
                        <div className="flex justify-center gap-x-6 w-full overflow-scroll pl-20 md:p-0 sm:p-0">
                            ...
                            <div onClick={() => {
                                window.location.href = "https://wa.me/251936489696"
                            }}
                                className="relative flex flex-col justify-center items-center gap-4 w-20 h-24 cursor-pointer duration-300 hover:*:not-first:top-0 hover:*:not-first:bg-green-600 hover:*:not-first:text-white hover:*:not-last:px-10 hover:*:not-last:pr-2">

                                <div className="rounded-full  py-1.5 px-2 duration-300 pr-6 bg-green-600">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="#ffffff" version="1.1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
