            ...
            <div className="flex flex-col gap-y-4 px-2">
                ...
                <div className="mt-2 flex flex-wrap items-center gap-3">
                    ...
                    <div className="relative bg-foreground text-background px-4 py-2 rounded-full transition-all duration-300 hover:scale-105 cursor-pointer flex items-center gap-2 shadow-sm">
                        ...
                        <a href={"tel:+251936489696"} className="absolute inset-0" aria-label="Phone contact"></a>
                    </div>
                
                    <div className="relative bg-foreground text-background px-4 py-2 rounded-full transition-all duration-300 hover:scale-105 cursor-pointer flex items-center gap-2 shadow-sm">
                        <img src="/telegram.svg" alt="TELEGRAM" className="w-4 h-4 brightness-0 invert" />
                        <span className="text-xs font-semibold">Telegram</span>
                        <a href={"https://t.me/abuhanifainstallation"} className="absolute inset-0" target="_blank" rel="noopener noreferrer" aria-label="Telegram contact"></a>
                    </div>
                    ...
                    <div className="relative bg-foreground text-background px-4 py-2 rounded-full transition-all duration-300 hover:scale-105 cursor-pointer flex items-center gap-2 shadow-sm">
                        ...
                        <a href={`mailto:abuhanifainstalltion@gmail.com`} className="absolute inset-0" aria-label="Email contact"></a>
                    </div>
