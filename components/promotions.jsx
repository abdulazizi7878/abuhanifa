...
function Promotion({ title, description, image, resourceType, name, email, phone_number, telegram, link }) {
    ...
    return (
        <div className="w-full border-b border-[var(--border)] pb-12 flex flex-col gap-y-5">
            
            {/* Title Section (Above Media) */}
            <div className="flex flex-col gap-y-1 px-2">
                <h2 className="text-2xl sm:text-3xl font-black tracking-tight text-[var(--foreground)] leading-tight">
                    {title}
                </h2>
            </div>
            ...
            <div className="flex flex-col gap-y-4 px-2">
                ...
                <div className="mt-2 flex flex-wrap items-center gap-3">
                    <span className="font-bold text-sm text-[var(--foreground)] opacity-80">Contact us:</span>
                    
                    {phone_number && (
                        <div className="relative bg-[var(--foreground)] text-[var(--background)] px-4 py-2 rounded-full transition-all duration-300 hover:scale-105 cursor-pointer flex items-center gap-2 shadow-sm">
