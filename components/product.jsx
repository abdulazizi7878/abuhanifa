        ...
        <div className="w-full p-4 flex flex-wrap justify-evenly border-b border-b-(--border)/50 pb-8 mb-8 gap-4 bg-foreground/2">
            <div className="w-full sm:w-11/24 flex flex-col justify-center items-center bg-foreground/6 border border-(--border)/20 rounded-4xl px-4 py-8">
                 ...
                 <div className="w-full flex justify-around mt-10">
                    <button onClick={()=>Share()} className="cursor-pointer transition-all duration-300 p-3 rounded-2xl hover:pl-7 hover:bg-foreground/10 bg-foreground/20">
                    ...
                    <a href={`/products/${link}/order`} className="cursor-pointer transition-all duration-300 p-3 px-5 rounded-2xl hover:pl-7 hover:bg-foreground/70 bg-foreground text-background">
                        order 
                    </a>
                 </div>
            </div>
