...
function Blog({title,description,image,created_at,link}){
    return(
        <div className="pb-6 w-full sm:w-82 md:w-82 lg:w-82 overflow-hidden border border-[var(--border)] rounded-2xl flex flex-col justify-center items-center gap-y-4 relative">
