    ...
    return (
        <footer className="w-full pt-10 flex flex-col justify-center items-center gap-10 border-t border-t-(--border)">
            ...
            <div className="mt-15  gap-x-6 gap-y-4 flex flex-wrap w-11/12 justify-center items-center">
                ...
                {/* WhatsApp */}
                <div className="relative">
                    <div className="rounded-full py-1.5 px-2 pr-6 bg-emerald-600">
                    ...
                    <span className="text-sm hidden code-aa">WhatsApp</span>
                    <a href="https://wa.me/251936489696" className="absolute inset-0"></a>
                </div>

                {/* TikTok */}
                <div className="relative">
                    <div className="rounded-full py-1.5 px-2 pr-6 bg-black">
                    ...
                    <span className="text-sm hidden code-aa" >TikTok</span>
                    <a href="https://tiktok.com/@ahieth" className="absolute inset-0"></a>
                </div>

                {/* YouTube */}
                <div className="relative">
                    <div className="rounded-full py-1.5 px-2 pr-6 bg-red-600">
                    ...
                    <span className="text-sm hidden code-aa" >YouTube</span>
                    <a href="https://youtube.com/@ahieth" className="absolute inset-0"></a>
                </div>

                {/* Facebook */}
                <div className="relative">
                    <div className="rounded-full py-1.5 px-2 pr-6 bg-blue-500">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="#ffffff" version="1.1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                            <path d="M12 2C6.5 2 2 6.5 2 12c0 5 3.7 9.1 8.4 9.9v-7H7.9V12h2.5V9.8c0-2.5 1.5-3.9 3.8-3.9 1.1 0 2.2.2 2.2.2v2.5h-1.3c-1.2 0-1.6.8-1.6 1.6V12h2.8l-.4 2.9h-2.3v7C18.3 21.1 22 17 22 12c0-5.5-4.5-10-10-10z"></path>
                        </svg>
                    </div>
                    <span className="text-sm hidden code-aa" >Facebook</span>
                    <a href="https://www.facebook.com/profile.php?id=61587213729895" className="absolute inset-0"></a>
                </div>

                {/* Instagram */}
                <div className="relative">
                    <div className="rounded-full py-1.5 px-2 pr-6 bg-orange-600">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="#ffffff" version="1.1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                    ...
                    <span className="text-sm hidden code-aa" >Instagram</span>
                    <a href="https://www.instagram.com/nurye3107?igsh=aHFncm13YnVwNDMz" className="absolute inset-0"></a>
                </div>
